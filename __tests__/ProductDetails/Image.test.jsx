...
test('Renders the status component', () => {
  ...
  scrollUp.simulate('click');
  expect(wrapper).toContainMatchingElements(9,'img');

  const scrollDown = wrapper.find('.p_down');
  scrollDown.simulate('click');
  expect(wrapper).toContainMatchingElements(9,'img');

  const scrollRight = wrapper.find('.p_right').at(0);
  scrollRight.simulate('click');
  expect(wrapper).toContainMatchingElements(9,'img');
